        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <FadeUp key={feature.title} delay={i * 100}>
              <div className="group relative rounded-xl border border-border bg-card p-8 card-glow transition-all duration-300 h-full">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-accent/10 text-accent mb-6 group-hover:bg-accent/15 transition-colors duration-300">
                  {feature.icon}
                </div>
