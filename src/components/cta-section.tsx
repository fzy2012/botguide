        ...
        <FadeUp>
          <div className="rounded-2xl border border-border bg-card p-10 lg:p-14 text-center">
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground mb-8 text-balance max-w-2xl mx-auto leading-relaxed">
              {"发现了好教程？有优质的学习资源？欢迎推荐给我们，你的分享将帮助更多人。"}
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-xl border border-border bg-background px-8 py-4 text-base font-medium text-foreground transition-all duration-300 hover:border-accent/30 hover:bg-accent/5"
              >
                <span>{"加入入行 365 社区"}</span>
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <FadeUp delay={100}>
          <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-10 text-balance">
            {"BotGuide 持续更新，入行 365 全生态助你从入门到精通"}
          </p>
        </FadeUp>
